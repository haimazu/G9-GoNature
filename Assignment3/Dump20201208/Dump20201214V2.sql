...
INSERT INTO `employee` VALUES ('bark','12345678','bar','katz',1,'bar@Nature.com','ParkManager','jurasic'),('hodaya','12121212','Hodaya','Mekonen',12,'your@gmail.com','ServiceRepresentative','idk'),('yohanan','12121212','Yohanan','Mekonen',112,'your@gmail.com','DepartmentManager','idk'),('haim','12121212','Haim','Azulay',123,'your@gmail.com','ParkManager','idk'),('lala','12121212','Lala','Mekonen',1112,'your@gmail.com','ParkEmployee','idk');
...
CREATE TABLE `orders` (
  ...
  `visitorsNumber` int DEFAULT NULL,
  `email` varchar(45) DEFAULT NULL,
  `orderType` varchar(45) DEFAULT NULL,
  `price` float DEFAULT NULL,
  `parkName` varchar(45) DEFAULT NULL,
  `arrivedTime` varchar(45) DEFAULT NULL,
...
INSERT INTO `orders` VALUES (1111,10,'a@b.c','guide',400,'jurasic','2021-01-02 10:00:00',1,NULL,NULL);
...
-- Dump completed on 2020-12-14 21:53:50

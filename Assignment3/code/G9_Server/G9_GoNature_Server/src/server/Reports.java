...
public class Reports {
	 ...
	 * all parks. sends to client: Array list that contains: [1-n] -> Array list of
	 ...
	 *                [0] -> String parkName [1] -> String startDate in a following
	 *                date format: (YYYY-MM-DD) [2] -> String endDate in a following
	 ...
	 * contains: [0-n] -> Array list of string that contains: (n depends on number
	 * of entries in the DB) [0] -> date and time of a capsule that was not full [1]
	 * -> Difference between max allowed and actual arrived
	 * 
	 ...
	 * time (0-1, 1-2, 2-3, 3-4), generated by visitors type. sends to client:
	 * ArrayList<Object> cell[0] name cell[1] 0-1 percentage of visitors cell[2] 1-2
	 * percentage of visitors cell[3] 2-3 percentage of visitors cell [4] 3-4
	 * percentage of visitors.
	 * 
	 * @param recived ArrayList<Object> cell[0] calling function name cell[1] from
	...
	/**
	 * Cancellation and visits lost Report. sends to client: ArrayList<Object>:
	 * cell[0] func_name cell[1] ArrayList<String> of rows in query
	 * 
